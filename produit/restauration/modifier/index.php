	...
	<table border=0 cellpadding=0 cellspacing=0 >
		...
		<?php } //$get_name ?>
			<td class=inputnum><label><a href="">Date départ du circuit</a></label>
				<input type="text" name="numcontact" value="dpt+jour-1"  id="numcontact"  />
	...
	<table border=0 cellpadding=0 cellspacing=0 >
		<TR class="niv1">
			<TD  COLSPAN=4 ALIGN=CENTER VALIGN=MIDDLE >				<B>RESTAURATION</B>										</TD>	
		</TR>
		<TR class="niv2" HEIGHT=16 ALIGN=LEFT >
			<TD STYLE="width:5%;  " >						<B>Jour</B>											</TD>
			<TD STYLE="width:85%;  " >						<B>Prestation</B>										</TD>
		...
		<TR ALIGN=LEFT>
			<TD>	<input type="text" value="<?php echo $restauration['jours']  ; ?>" name="jours" id="jours"  />									</TD>
			<TD>	<input type="text" value="<?php echo $restauration['designation']  ; ?>" name="designation" id="designation"  />						</TD>
			<TD>	<input type="text" value="<?php echo $restauration['horaire']  ; ?>" name="horaire" id="horaire"  />								</TD>
		</TR>
			</form>

	...
	<table border=0 cellpadding=0 cellspacing=0 >
		...
		<?php } //$get_name ?>
			...
			<form  action="enregistrer.php"  method="post">
				...
				<input type="text" name="attribut" value="visite" id="attribut"  hidden/>
				<input type="text" name="jour" value="0" id="jour" hidden />
			</td>
		</tr>
	</table>
	<br>
	<table border=0 cellpadding=0 cellspacing=0 >
		<TR class="niv1">
			<TD  COLSPAN=3 ALIGN=CENTER VALIGN=MIDDLE >		<B>VISITE</B>													</TD>	
		</TR>

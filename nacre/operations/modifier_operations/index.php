	...
	<?php
	$sql2 = 'SELECT * FROM retroplanning WHERE position = '.$admin['position'].' ';
	$req2 = mysql_query($sql2) or die('Erreur SQL !<br>'.$sql2.'<br>'.mysql_error());
	while($courrier = mysql_fetch_assoc($req2)) { ?>
	...
	<table border=0 cellpadding=0 cellspacing=0  >
		<TR class="niv1">
			<TD  COLSPAN=6 ALIGN=CENTER VALIGN=MIDDLE >				<B>MODIFIER OPÉRATION</B>									</TD>	
		</TR>

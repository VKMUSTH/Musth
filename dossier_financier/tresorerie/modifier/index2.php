	...
	<table border=0 cellpadding=0 cellspacing=0 >
		...
		<TR HEIGHT=16 ALIGN=LEFT class="niv2">
				...
				<TD STYLE="width:10%;" >					<B>Etat</B>				</TD>
				<TD STYLE="width:10%; border-right: 1px solid #b8bec3" >	<B>Débit</B>				</TD>
				<TD STYLE="width:10%; border-right: 1px solid #b8bec3" >	<B>Crédit</B>				</TD>
		...
		<TR ALIGN=LEFT>
			...
			<TD>							<input type="text" name="credit" id="credit" value="<?php echo $inscription['credit']  ; ?>" />	</TD>

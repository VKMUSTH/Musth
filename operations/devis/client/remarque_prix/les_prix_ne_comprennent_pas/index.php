	...
	<table border=0 cellpadding=0 cellspacing=0 >
		<TR class=niv1>
			<TD  COLSPAN=8 ALIGN=CENTER VALIGN=MIDDLE >				<B>LES PRIX NE COMPRENNENT PAS</B>			</TD>
		</TR>
		<TR HEIGHT=16 ALIGN=LEFT class="niv2">
			<TD STYLE="width:90%; border-left: 1px solid #b8bec3;   " >		<B>Libellé</B>						</TD>
		...
		<TR ALIGN=LEFT>
			...
			<TD STYLE="border-left: 1px solid #b8bec3">	<input type="text" value="<?php echo $voyageurs['remarque']  ; ?>"  />		</TD>
